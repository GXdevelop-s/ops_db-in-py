...
def master_process_second(pre_precessed_df):
    ...
    final_count_result = further_process_count(count_result)
    ...
    final_latency_result = further_process_latency(latency_result)
...
def send_metrics(final_count_result, final_latency_result, final_avg_latency_result):
    ...
    while len(kafka_data_holder) > 0:
        ...
        producer.produce('garrett_test_s3', value=json.dumps(ready_element))
